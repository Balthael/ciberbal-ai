...
var linearRoutes = map[Screen]Route{
	...
	ScreenDetection:              {Forward: ScreenInstallMode, Backward: ScreenWelcome},
	ScreenInstallMode:            {Forward: ScreenAgents, Backward: ScreenDetection},
	ScreenAgents:                 {Forward: ScreenPersona, Backward: ScreenInstallMode},
