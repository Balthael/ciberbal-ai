...
type Model struct {
	...
	// QuickInstall is true when the user selects "Quick install" on ScreenInstallMode.
	// When true, Agents/Persona/Preset screens are skipped and defaults are pre-filled.
	QuickInstall bool
...
func (m Model) View() string {
	...
	case ScreenInstallMode:
		return screens.RenderInstallMode(m.Cursor)
	case ScreenAgents:
...
func (m Model) optionCount() int {
	...
	case ScreenInstallMode:
		return len(screens.InstallModeOptions())
	case ScreenAgents:
