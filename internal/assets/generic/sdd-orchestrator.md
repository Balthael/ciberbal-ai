# Ciberbal Agent Teams Lite — Orchestrator Instructions
...
ALL sub-agent launch prompts that involve reading, execution, or evidence review MUST include pre-resolved **compact rules** from the skill registry. Follow the **Skill Resolver Protocol** (see `_shared/skill-resolver.md` in the skills directory).
