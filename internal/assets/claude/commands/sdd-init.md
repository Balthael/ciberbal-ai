...
TASK:
Initialize the engagement context. Identify the authorized target, confirm scope and Rules of Engagement (ROE), detect the engagement environment, and bootstrap the active persistence backend according to the resolved artifact store mode.
