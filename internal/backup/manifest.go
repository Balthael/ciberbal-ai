...
type Manifest struct {
	...
	// CreatedByVersion is the ciberbal-ai version that created this backup.
...
func backupRoot() (string, error) {
	...
	return filepath.Join(home, ".ciberbal-ai", "backups"), nil
}
...
// of the expected backup root (~/.ciberbal-ai/backups/). This prevents a tampered
