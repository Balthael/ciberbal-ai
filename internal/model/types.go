...
const (
	...
	SkillDomainWeb                SkillID = "domain-web"
	SkillDomainAPI                SkillID = "domain-api"
	SkillDomainMobile             SkillID = "domain-mobile"
	SkillDomainADInternal         SkillID = "domain-ad-internal"
	SkillDomainWiFi               SkillID = "domain-wifi-wireless"
	SkillDomainCloud              SkillID = "domain-cloud"
	SkillDomainRecon              SkillID = "domain-recon"
	SkillDomainReporting          SkillID = "domain-reporting"
	SkillWorkflowScoping          SkillID = "workflow-scoping"
	SkillWorkflowRecon            SkillID = "workflow-recon"
	SkillWorkflowEnumeration      SkillID = "workflow-enumeration"
	SkillWorkflowExploitation     SkillID = "workflow-exploitation"
	SkillWorkflowPostExploitation SkillID = "workflow-post-exploitation"
	SkillWorkflowEvidence         SkillID = "workflow-evidence"
	SkillWorkflowReporting        SkillID = "workflow-reporting"
)
...
const (
	PresetFullPentest   PresetID = "full-pentest"
	PresetEcosystemCore PresetID = "ecosystem-core"
