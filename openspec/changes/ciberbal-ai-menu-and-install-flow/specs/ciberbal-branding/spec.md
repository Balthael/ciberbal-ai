...
Defines the rebranding from gentle-ai to ciberbal-ai in MVP-safe places such as the welcome menu and CLI outputs.

## Requirements

### Requirement: MVP Branding

The system MUST display "ciberbal-ai" branding in the main welcome menu and other MVP-safe user-facing text, replacing "gentle-ai".
