...
Every time you run `ciberbal-ai install`, `sync`, or `upgrade`, the system:
...
1. Run `ciberbal-ai` and navigate to the **Backups** screen
...
2. Restore from latest snapshot via the TUI or `ciberbal-ai restore latest`
